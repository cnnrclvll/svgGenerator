    ...
    run() { // function to run prompt
        ...
        .prompt([ // questions to generate logo
            ...
            },
            {
                name: "shapeHue",
                type: "input",
                message: "Enter a color for the shape in your logo (simple text or hexadecimal numbers accepted).",
            }
        ])
        .then(({ txt, txtHue, shape, shapeHue }) => // callback function taking the user responses
        {
            ...
            logo.txtTouch(txt, txtHue, logoShape); // send txt and attributes to SVG function
